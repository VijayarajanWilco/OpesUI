package com.wilco.opesui.financeplan_modules;
...
public class LifeStyleDept extends AppCompatActivity implements OnChartGestureListener,OnChartValueSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_life_cycle_dept);

        toolbar = (Toolbar) findViewById(R.id.toolbar_LifeStyle);
        toolbar.setTitle("Lifestyle Dept");
        ...
        leftAxis.setAxisMaxValue(250000f);
